...
contract TicketFactory is Ownable {
     ...
     */
    function createNewTicket(address owner, string memory name, string memory symbol) external returns (address) {
        Ticket ticket = new Ticket(owner, name, symbol, trustedForwarder);
