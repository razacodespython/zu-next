...
contract TicketVerifier is Utils {
    uint public ticketAmount;
    mapping(string eventName => uint participantAmoun) public participantAmounts;
    ...
    constructor(address verifierAddress) {
        ...
        messagePrefix = string(abi.encodePacked(
                "{\"types\":{\"EIP712Domain\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"version\",\"type\":\"string\"},{\"name\":\"chainId\",\"type\":\"uint256\"},{\"name\":\"verifyingContract\",\"type\":\"address\"}],\"Comment\":[{\"name\":\"event\",\"type\":\"string\"},{\"name\":\"description\",\"type\":\"string\"}]},\"primaryType\":\"Comment\",\"domain\":{\"name\":\"Zupass Tickets\",\"version\":\"1\",\"chainId\":534351,\"verifyingContract\":\"0x",
                myAddress,
                "\"},\"message\":{\"event\":\""));
        messageMiddlefix = "\",\"description\":\"";
        messageSuffix = "\"}}";
    }

    function isValidHash(bytes32 hash, string memory eventName, string memory description) public view returns(bool) {
        string memory jsonMessage = string(abi.encodePacked(messagePrefix, eventName, messageMiddlefix, description, messageSuffix));
    ...
    function sendProof(bytes calldata _proof, bytes32[] calldata _publicInputs, string memory eventName, string memory description) public
    {
        // Check signature
        require(isValidHash(concatenateHexArray(_publicInputs), eventName, description), "Invalid message hash");
        ...
        // Function logic
        participantAmounts[eventName] += 1;
        ticketAmount += 1;
    }
}
